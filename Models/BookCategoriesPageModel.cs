...
namespace Pascu_Bianca_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Pascu_Bianca_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Pascu_Bianca_Lab8Context context,
